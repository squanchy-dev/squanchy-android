...
class RepositoryModule {
    ...
    @Provides
    internal fun eventService(firestoreDbService: FirestoreDbService, checksum: Checksum): EventRepository {
        return FirestoreEventRepository(firestoreDbService, checksum)
    }
