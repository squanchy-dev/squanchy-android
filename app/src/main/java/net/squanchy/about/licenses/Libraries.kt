...
internal object Libraries {
    ...
    val LIBRARIES = listOf(
            ...
            Library("Twitter Kit for Android", "Twitter Inc.", License.APACHE_2),
            Library("ViewPagerAdapter", "Novoda Ltd.", License.APACHE_2),
            Library("AutoValue", "Google Inc.", License.APACHE_2),
            Library("Dagger", "the Dagger Authors", License.APACHE_2),
            Library("Retrolambda", "Esko Luontola and other Retrolambda contributors", License.APACHE_2),
            Library("Gradle Retrolambda Plugin", "Evan Tatarka", License.APACHE_2),
