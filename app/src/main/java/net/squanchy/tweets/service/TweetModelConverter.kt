...
class TweetModelConverter(private val tweetSpannedTextBuilder: TweetSpannedTextBuilder) {

    internal fun toViewModel(tweet: Tweet): TweetViewModel {
    ...
    private fun onlyHashtagsInRange(entities: List<HashtagEntity>, displayTextRange: Range): List<HashtagEntity> =
        entities.filter { entity -> displayTextRange.contains(entity.start, entity.end) }
