...
import net.squanchy.model.data.SpeakerDetailsEvent;
...
import net.squanchy.ui.adapter.item.BofsItem;
import net.squanchy.ui.adapter.item.EventListItem;
import net.squanchy.ui.adapter.item.ProgramItem;
import net.squanchy.ui.adapter.item.SocialItem;
import net.squanchy.utils.ArrayUtils;
import net.squanchy.utils.CursorParser;
import net.squanchy.utils.CursorStringParser;
